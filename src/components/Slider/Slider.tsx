  ...
  return (
      <Box position='relative' height='48px' {...props}>
          ...
          <BunnySlider>
              ...
              <BarProgress isMax={isMax} style={{ width: progressWidth }} disabled={disabled} />
              <StyledInput name={name} type='range' min={min} max={max} value={value} step={step} onChange={handleChange} isMax={isMax} disabled={disabled} />
          </BunnySlider>
          {valueLabel && (
              <SliderLabelContainer>
