...
const Icon: React.FC<SvgProps> = ({ ...props }) => {
  return (
      <Svg viewBox='0 0 28 27' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
          ...
          <path
              d='M24 23h-5v-5h5v5zm-7.5 0h-5v-5h5v5zM9 23H4v-5h5v5zm15-7.5h-5v-5h5v5zm-7.5 0h-5v-5h5v5zm-7.5 0H4v-5h5v5zM24 8h-5V3h5v5zm-7.5 0h-5V3h5v5zM9 8H4V3h5v5z'
          />
          <defs>
