...
export { default as DefifarmsRoundIcon } from "./Icons/DefifarmsRound";
...
export { default as DarkIcon } from "./Icons/DarkMode";
export { default as LightIcon } from "./Icons/LightMode";
export { default as WaitIcon } from "./Icons/Wait";
export { default as DefaultAvatarIcon } from "./Icons/DefaultAvatar";
