  ...
  return (
    <Box width="640px">
      <BrowserRouter>
        ...
        <Row>
          <Button startIcon={<LogoIcon width="24px" color="secondary"/>}>Start Icon</Button>
          <Button endIcon={<LogoIcon width="24px" color="secondary"/>}>End Icon</Button>
          <Button startIcon={<LogoIcon width="24px" color="secondary"/>} endIcon={<LogoIcon width="24px" color="secondary"/>}>
            Start & End Icon
          </Button>
        </Row>
        <Row>
          <IconButton>
            <LogoIcon width="24px" color="secondary"/>
          </IconButton>
